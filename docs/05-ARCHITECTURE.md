...
Les pages partagent le shell, des espacements adaptés à l'écran et un `h1` accessible, focalisé lors de la navigation. Dashboard et Collection disposent d'une présentation large ; Profil et Paramètres conservent une largeur de lecture limitée. Dashboard affiche les collections personnelles et partagées, leur progression et la création personnalisée ; il conserve le message éventuel après changement de mot de passe. L'identifiant public MY. est présenté dans Profil. Le footer reste commun. Le [rapport Phase 3C](reports/2026-09-12-PHASE3C-SHELL.md) conserve l'état historique du shell minimal ; la Phase 4 a livré la gestion du compte et la Phase 5 les interfaces Collections. Paramètres reste minimal. Profil et Paramètres restent accessibles séparément par `Mon compte`, sans raccourci vers Paramètres dans Profil.
