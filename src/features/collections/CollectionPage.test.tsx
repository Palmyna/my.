...
test.each([
  ...
  expect(screen.getByText(collection.access === 'shared' ? 'Partagée · Lecture seule' : 'Votre collection')).toBeVisible()
  ...
  expect(title.parentElement).toHaveStyle({ '--collection-accent': collectionColor(collection).accent })
