...
**Phases 0 à 3 terminées et validées.** La **Phase 4 — Profil et gestion du compte** est **cadrée et en cours d'implémentation**. Le [socle de changement d'email](docs/reports/2026-09-13-PHASE4B2-ACCOUNT-AUTH.md) et le [backend de suppression sécurisée](docs/reports/2026-09-14-PHASE4B3-ACCOUNT-DELETION.md) sont livrés et validés localement. La [page Profil 4C](docs/reports/2026-09-14-PHASE4C-PROFILE.md) conserve son identité MY. copiable, sa date d'inscription Auth et son changement d'email. La [Phase 4D.1](docs/reports/2026-09-15-PHASE4D1-PASSWORD-PROFILE.md) ajoute le formulaire de changement volontaire du mot de passe et regroupe sa présentation avec l'Authenticator dans **Sécurité du compte**, après Identité MY. et Adresse email. Formulaire et contrat `password` / `current_password` sont validés localement ; la vérification serveur du mot de passe actuel reste à valider sur Supabase Cloud en 4D.3, la CLI 2.117.0 ne résolvant pas la limitation locale connue. La [Phase 4D.2](docs/reports/2026-09-15-PHASE4D2-ACCOUNT-DELETION-UX.md) livre la suppression depuis Profil en trois étapes, avec appel final unique, erreurs explicites et purge Auth/cache après succès confirmé. Il reste uniquement **4D.3 — checkpoint Cloud final** pour clôturer la Phase 4. La [vérification initiale Auth](docs/reports/2026-09-13-PHASE4B1-REAUTH.md) reste conservée. La [roadmap globale](docs/08-ROADMAP.md) définit l'ordre des grandes phases jusqu'à la V1.
